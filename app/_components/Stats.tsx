...
function Stats() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-black p-6 gap-4'>
        <div className='flex flex-col items-center justify-center text-white h-52 border-r border-gray-600 last:border-r-0'>
